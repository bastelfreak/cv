...
\begin{itemize}
  \item DevOps Engineer:
    \begin{itemize}
      \item Architect and deploy a scaleable ELK-Stack with Graylog;
      \item Plan and execute migrations from Puppet versions 3 to 4 to 5;
      \item Write and contribute to 120+ public Puppet modules, (including facts, types \& providers, unit and acceptance tests);
      \item Design and build a technical fabric to provision physical servers for multiple brands;
      \item Plan the architecture of a cloud platform based on Qemu and Kubernetes, including a scaling network topology;
      \item Provide self services for developers with Puppet (Consul, Vault, Kafka, Databases, Firewalling, Monitoring);
      \item Package software for Archlinux. Operate and improve the package build systems and package repositories;
      \item Mentor students for their Bachelor and Master thesis;
      \item Product Owner for multiple infrastructure services.
    \end{itemize}
  \item System Administrator:
    \begin{itemize}
      \item Operate multiple Puppet-managed Cloud platforms with more than 3300 nodes;
...
\tlcventry{2012}{2014}{Systems Engineer}{\href{https://hetzner.de/}{Hetzner Online AG}}{Falkenstein}{}{Lead a cloud platform, maintained datacenter infrastructure
\begin{tightitemize}
...
\begin{tightitemize}
  ...
  \item Keep track of outdated module/gem dependencies and regular releases;
...
\begin{tightitemize}
 \item Review and merge incoming patches for 150+ Puppet modules and tools;
 \item Maintain the test matrix for 100+ Puppet modules and do release management;
 \item Provide patches and reviews for all major Puppet Inc. owned modules;
...
\tllabelcventry{2014}{2018}{\kern-2em 2014--2018}{Equivalent to B.Eng. Computer Science}{\href{http://www.hhek.bonn.de/front_content.php?idcat=120}{Heinrich-Hertz-Europakolleg der Bundesstadt Bonn}}{Valedictorian}{}{}
