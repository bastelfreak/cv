...
\begin{itemize}
  \item DevOps Engineer:
    \begin{itemize}
      ...
      \item Wrote and contributed to 150+ public Puppet modules, (includes facts, types \& providers, unit and acceptance tests);
...
\begin{tightitemize}
  \item Provide feedback, guidance and knowledge transfer across 140+ contributors;
...
\begin{tightitemize}
 \item Developed and realized a migration plan from Puppet Version 3 \rightarrow\ 4 \rightarrow\ 5 \rightarrow\ 6;
 \item Reviewed and merged incoming patches for 150+ Puppet modules and tools;
 \item Maintained the test matrix for 130+ Puppet modules and do release management;
